                ...
                if isinstance(solid, Cube):
                    ...
                    if collides:
                        solid.center_dist = math.sqrt(
                            math.pow(
                                self.scene.camera.position.x - solid.position.x, 2) + math.pow(
                                self.scene.camera.position.y - solid.position.y, 2) + math.pow(
                                self.scene.camera.position.z - solid.position.z, 2))
